...
const recommendationGroundingProvider = createRecommendationGroundingProvider()
const server = createWorkerServer({
  ...
  connectionDeletion: async ({ userId, connectionId, deletionRequestId }) => {
    const result = await processConnectionDeletionTask({
      userId,
      connectionId,
      deletionRequestId,
      provider,
  ...
  recommendations: async ({ userId, period }) => {
    ...
    logger.info(
      {
        ...
        aiProvider: result.aiMetadata?.provider,
        aiModel: result.aiMetadata?.model,
        promptVersion: result.aiMetadata?.promptVersion,
        aiOutputSchemaVersion: result.aiMetadata?.outputSchemaVersion,
        aiLatencyMs: result.aiMetadata?.latencyMs,
        aiPromptTokens: result.aiMetadata?.promptTokens,
        aiCompletionTokens: result.aiMetadata?.completionTokens,
        aiTotalTokens: result.aiMetadata?.totalTokens,
        aiInputBytes: result.aiMetadata?.inputBytes,
        aiOutputBytes: result.aiMetadata?.outputBytes,
        aiEstimatedCostMicros: result.aiMetadata?.estimatedCostMicros,
      },
      'Recommendations generated by worker',
    )
    return result
  },
  logger,
